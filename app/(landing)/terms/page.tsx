      ...
      <div className="relative w-full max-w-4xl mx-auto space-y-10 z-10">
        ...
        <div className="rounded-3xl border border-border bg-card/95 backdrop-blur-2xl p-6 sm:p-8 shadow-xl space-y-4">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
            By creating an account or accessing the <strong className="text-foreground">EVAL CV</strong> platform, you agree to comply with and be bound by the following Terms of Service. Please read these terms carefully before utilizing our AI candidate evaluation services.
          </p>
        </div>
        ...
        <div className="space-y-8 text-xs sm:text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="rounded-3xl border border-border bg-card/60 p-6 sm:p-8 space-y-3">
            ...
            <p>
              To use EvalCv, you must be at least 18 years of age or possess the legal authority to represent your organization. You are responsible for maintaining the secrecy of your credentials and all actions conducted under your account.
            </p>
          </section>
          ...
          <section className="rounded-3xl border border-border bg-card/60 p-6 sm:p-8 space-y-3">
            ...
            <p>
              EvalCv provides candidate matching insight algorithms for informational recruitment support. Final hiring decisions rest solely with the recruiter or organization. EvalCv is not liable for indirect or consequential damages arising from recruitment outcomes.
            </p>
          </section>
        </div>
